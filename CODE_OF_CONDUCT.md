...
This project adopts the [Contributor Covenant v2.1][cc]. The full
text is reproduced below for convenience; the canonical source is
the link above.
...
enforcement at the email address listed in the repository's
